...
- backend Firebase configuration is checked in for Functions, Firestore, and Storage; Firebase Hosting and environment-specific project/target mapping remain absent;
